...
async fn get_stats(
    ...
    // Stats columns not yet populated — return zero values until orbit-agent populates them
...
/// added once the orbit-agent gRPC credential-forwarding layer is in place.
