...
CREATE TABLE sites (
    ...
    document_root       TEXT,                                    -- /home/jotti_example/htdocs
    php_fpm_socket      TEXT,                                    -- /run/php/jotti_example.sock
    cgroup_slice        TEXT,                                    -- website-jotti_example.slice
...
CREATE TABLE email_domains (
    ...
    site_id         UUID         REFERENCES sites(id) ON DELETE CASCADE,
    server_id       UUID         REFERENCES servers(id) ON DELETE SET NULL,
    dkim_selector   VARCHAR(64)  NOT NULL DEFAULT 'jotti',
