            ...
            {#if showHelp}
              ...
              <div class="help-popover" on:click|stopPropagation>
                ...
                <div class="example">
                  ...
                  You run a shop at <em>mystore.com</em>. You want to redesign the homepage. Instead of editing the live site and risking broken pages in front of customers, you click <em>"Create Staging"</em>. OrbitCP makes an identical copy at <em>staging.mystore.com</em>. You redesign there, test everything, then click <em>"Push to Live"</em> — and your visitors only ever see the finished result.
                </div>
