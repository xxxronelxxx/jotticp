...
**Tip:** OrbitCP issues the SSL certificate during site creation — your site is HTTPS-ready immediately.`
};
...
Manage DNS zones and records for all your domains using OrbitCP's built-in PowerDNS server.
...
- Wildcard certs: use DNS-01 challenge (requires DNS managed by OrbitCP)
