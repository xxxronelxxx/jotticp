...
<svelte:head>
  <title>Cloudflare DNS — OrbitCP</title>
</svelte:head>
...
<div class="p-4 lg:p-6 space-y-6">
  ...
  <div class="bg-card border border-border rounded-xl p-5">
    ...
    <div class="space-y-3 text-sm text-muted-foreground">
      <p>
        OrbitCP uses Cloudflare's DNS Edit API to create, update, and delete records inside your zone automatically
      ...
      <div class="grid gap-3 sm:grid-cols-3">
        ...
        <div class="bg-muted/30 border border-border rounded-lg p-3">
          ...
          <p class="text-xs">Paste the token and Zone ID here, then click Sync to push existing records immediately. OrbitCP will keep the zone in sync going forward.</p>
        </div>
      </div>
