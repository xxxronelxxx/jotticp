...
<div class="min-h-screen flex items-center justify-center bg-background p-4">
  <div class="w-full max-w-md">
    ...
    <div class="text-center mb-8">
      ...
      <h1 class="text-2xl font-bold text-foreground">OrbitCP</h1>
    ...
    <div class="bg-card border border-border
      ...
      {:else if step === 'totp'}
        ...
        <div class="mb-6">
          ...
          <p class="text-sm text-muted-foreground mt-1">
            Open your authenticator app and enter the 6-digit code for OrbitCP.
          </p>
        </div>
    ...
    <p class="text-center text-xs text-muted-foreground mt-6">
      OrbitCP v{import.meta.env.VITE_ORBIT_VERSION ?? '0.1.0'}
      &nbsp;·&nbsp;
      <a href="https://docs.orbitcp.io" target="_blank" rel="noopener"
