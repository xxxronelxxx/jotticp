#!/usr/bin/env bash
# JottiCP Roundcube setup — runs once on a fresh Ubuntu server.
# Replaces the old SOGo stack. Expects jotti-panel + Dovecot + Postfix already installed.
set -euo pipefail
...
echo "Roundcube setup complete for JottiCP."
