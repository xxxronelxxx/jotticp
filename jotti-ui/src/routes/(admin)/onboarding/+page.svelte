      ...
      {:else if currentStep === 3}
        <div class="space-y-4">
          <div>
            ...
            <p class="text-sm text-muted-foreground mt-1">
              Enter the domain or subdomain that points to this server. You'll use it to access JottiCP.
            </p>
          </div>
      ...
      {:else if currentStep === 4}
        <div class="space-y-4">
          <div>
            ...
            <p class="text-sm text-muted-foreground mt-1">
              Point your domain's nameservers to JottiCP to manage DNS for your sites.
            </p>
          </div>
