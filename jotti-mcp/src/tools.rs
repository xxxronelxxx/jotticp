...
pub fn tool_definitions() -> Vec<serde_json::Value> {
    vec![
        serde_json::json!({
            "name": "list_sites",
            "description": "List all websites managed by JottiCP",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "search": {
        ...
        serde_json::json!({
            "name": "create_site",
            "description": "Create a new website / virtual host in JottiCP",
            "inputSchema": {
                "type": "object",
        ...
        serde_json::json!({
            "name": "delete_site",
            "description": "Delete a website and all its resources from JottiCP",
            "inputSchema": {
                "type": "object",
                "required": ["site_id"],
                "properties": {
        ...
        serde_json::json!({
            ...
            "description": "List all email accounts managed by JottiCP",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "domain": {
        ...
        serde_json::json!({
            "name": "list_dns_zones",
            "description": "List all DNS zones managed by JottiCP",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "search": {
        ...
        serde_json::json!({
            "name": "list_ssl_certs",
            "description": "List all SSL/TLS certificates managed by JottiCP",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "expiring_soon": {
        ...
        serde_json::json!({
            "name": "list_databases",
            "description": "List all databases managed by JottiCP",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "site_id": {
        ...
        serde_json::json!({
            "name": "list_cron_jobs",
            "description": "List all cron jobs configured in JottiCP",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "site_id": {
